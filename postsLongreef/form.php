...
<body>
    <h1>Share Your Experience With Longreef!</h1>
...
$sql = "SELECT postslongreef.*, users.firstName, users.lastName 
        FROM postslongreef 
        JOIN users ON postslongreef.user_id = users.id 
        ORDER BY postslongreef.created_at DESC";
