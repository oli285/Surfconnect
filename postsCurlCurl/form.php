...
<head>
 ...
 <body>
     <h1>Share Your Experience With Curl Curl!</h1>
...
$sql = "SELECT postscurlcurl.*, users.firstName, users.lastName 
        FROM postscurlcurl
        JOIN users ON postscurlcurl.user_id = users.id 
        ORDER BY postscurlcurl.created_at DESC";
