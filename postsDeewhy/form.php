...
<body>
    <h1>Share Your Experience With Deewhy!</h1>
...
$sql = "SELECT postsdeewhy.*, users.firstName, users.lastName 
        FROM postsdeewhy 
        JOIN users ON postsdeewhy.user_id = users.id 
        ORDER BY postsdeewhy.created_at DESC";
